/*
    ...
    OpenGL ES loader generated by glad 0.1.36 on Tue Jun  9 09:45:03 2026.
    ...
    Commandline:
        --profile="compatibility" --api="gles2=3.2" --generator="c" --spec="gl" --omit-khrplatform --extensions=""
    Online:
